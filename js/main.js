...
const galleryCaptions = [
    ...
    "saya pooorrrteeeerrrrrrrrr",
    "makan banggg",
    "mangantuakk uda diaakk",
    "naruuuttooo saasuukeehhhh",
    "matahari pun tak mampu mengalahkan menyalanya kita",
    "panekk apaikk non",
    "yakinlah dibalik pemandangan yang indah ada beberapa rasa yang kita pendam",
    "Thank You and See You my love Green Chili Baby ."
...
function loadGalleryImage(number) {
    ...
    function tryNextImage() {
        ...
        if (extensionIndex >= extensions.length) {
            ...
            console.error(
                `Foto gallery${photoNumber} tidak ditemukan.`
            );
        ...
        const imagePath =
            `assets/images/gallery/gallery${photoNumber}.${extension}`;
